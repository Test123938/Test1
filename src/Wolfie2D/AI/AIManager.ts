...
/**
 * A manager class for all of the AI in a scene. Keeps a list of registered actors and 
 * handles AI generation for actors.
 * 
 * Testing making changes. Hello?
 */
...
export type AIConstructor = new <T extends AI>() => T;